---
title: AI Favors Software Incumbents
date: 2026-05-30
draft: true
---
...
- Internet vs AI
    ...
    - AI:
        ...
        - importantly, the data that AI uses is sourced from *incumbent software*
            link to: https://x.com/MerriamWebster/status/2036838132092424232?s=20
            - thus, the demand for SaaS seats might decline (as customers need fewer seats)
        - thesis for disruption:
            - lower demand for SaaS products. While this is *bad* for incumbents, it doesn't necessarily threaten their position relative to startup competition.
            - easier for new entrants (this is the topic im going to focus on)
