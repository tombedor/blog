...
Their newly released [Claude Code Review](https://code.claude.com/docs/en/code-review) feature is priced at a _very_ expensive [$15-$25 per PR](https://code.claude.com/docs/en/code-review#pricing). Its announcement came with little information as to why it should replace existing PR review workflows. This seems like a pricing experiment, to see how high a price enterprise is willing to tolerate.
...
Given today's low prices, there is relativewly little downward economic pressure on token usage. People reach for the most powerful model, regardless of the task at hand.
