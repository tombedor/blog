...
import ParityLagOverTimeChart from '@site/src/components/ParityLagOverTimeChart';
...
import BandwidthVsTopsChart from '@site/src/components/BandwidthVsTopsChart';
import TokensPerSecVsModelSizeChart from '@site/src/components/TokensPerSecVsModelSizeChart';
...
- Arguments:
    - Open source models catch up to frontier models relatively quickly
        <ParityLagOverTimeChart />
    - Laptops and phones are not that far off from being able to support big enough models
        - background on what the constraint is, explanation of memory bandwidth vs tops
            - <BandwidthVsTopsChart />
              <TokensPerSecVsModelSizeChart />
        - <MaxUsableModelChart />
