...
date: 2026-03-21
authors: [tom]
image: /diagrams/open-source-models/scenarios.png
---
...
![Feedback loops between frontier providers, remote models, and local open-source models](/diagrams/open-source-models/scenarios.png)
...
For now, running frontier open source models requires users to buy specialized hardware. However, the most recent Macbook 5 Pro Max looks to have made a leap in the size of model that's viable locally ([data](#on-device-model-size)):
