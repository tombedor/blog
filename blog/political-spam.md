...
Under [TCPA](link), cold-texts require prior consent if automated. If the text is auto-generated, cold-text are allowed by TCPA so long as a human actually [pushes the send button](https://docs.fcc.gov/public/attachments/DA-20-670A1.pdf).
