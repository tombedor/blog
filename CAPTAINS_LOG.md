...
- Updated the infrastructure source of truth to use Resend SMTP on port `2587` instead of `587`. From the production droplet, `587` and `465` timed out, while `2587` and `2465` connected.
